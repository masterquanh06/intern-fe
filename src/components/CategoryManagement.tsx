...
const CategoryManagement = () => {
  return (
    <div className="bg-white rounded-lg h-full p-2 md:p-4 border border-gray-200">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-2 hover:bg-gray-50 rounded gap-2">
